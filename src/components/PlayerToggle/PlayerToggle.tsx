...
const PlayerToggle: React.FC<Props> = ({ disabled=false, onCheck }) => {
	return (
		<>
			<label className="relative inline-flex items-center cursor-pointer">
				...
				<div
					className="
						w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer
				...
				<span className="ml-3 text-sm font-medium text-black">First move by Bot</span>
			</label>
		</>
	)
}
